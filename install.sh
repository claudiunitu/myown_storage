...
flock -x -w 600 /var/lock/myown_storage_rsync.lock rsync -av --delete --temp-dir="\$MOUNT_POINT_B/myown_storage_vault_backup_temp" "\$MOUNT_POINT_A/myown_storage_vault" "\$MOUNT_POINT_B/myown_storage_vault_backup" >> "\$LOG_FILE" 2>&1
